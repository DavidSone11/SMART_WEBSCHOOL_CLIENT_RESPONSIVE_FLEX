(function() {
	...
	'use strict';
	var userService = angular.module('sbAdminApp');
	...
	userService
		.provider("UserService",
			function() {
				...
				provider.$get = function($q,$timeout,$http,$cookies) {
					var service = {};
					service.config = {};
					...
					service.getUser = function() {
						...
						if(config.user == null){
							$http.get('/api/custom/user/myDetails').then(function(user){
								$http.get('/api/users/'+user.id,['role']).then(function(userModel){
